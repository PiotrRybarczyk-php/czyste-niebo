    <footer class="page-footer font-small pt-4">
      ...
      <div class="container text-center text-md-left" style="max-width:1200px;">

        <div class="row text-center text-md-left mt-3 pb-3">

          <div class="col-md-3 col-lg-3 col-xl-3 mx-auto mt-3">
            <a href="<?= base_url() ?>">
              <h6 class="text-uppercase mb-4 font-weight-bold"><?= $contact->company; ?></h6>
            </a>
          ...
          <div class="col-md-2 col-lg-2 col-xl-2 mx-auto mt-3">
            <a href="<?= base_url() ?>oferta">
              <h6 class="text-uppercase mb-4 font-weight-bold">Oferta</h6>
            </a>
