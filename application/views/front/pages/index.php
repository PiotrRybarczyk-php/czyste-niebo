    			...
    			<div class="row">
    				...
    				<div class="col-md-6 mb-4 text-center d-flex align-items-center">
    					<div>
    						...
    						<a target="_blank" href="<?= base_url() ?>ofirmie" class="btn button_main btn-md my__btn__dark">Czytaj więcej <i class="fas fa-angle-right"></i></a>
    					</div>
    					...
    					<div class="row">
    						...
    						<div class="col-md-6 mb-4 text-center d-flex align-items-center">
    							<div>
    								...
    								<?php if ($key->link) : ?>
    									<a target="_blank" href="<?= $key->link ?>" class="btn button_main btn-md my__btn__dark">Czytaj więcej <i class="fas fa-angle-right"></i></a>
    								<?php endif; ?>
    							</div>
    						</div>
    					</div>
    		...
    		<div class="container mb-5">
    			<div class="row">
    				<?php if ($atributes[4]->title) : ?>
    					<a target="_blank" href="<?= $atributes[4]->link; ?>" class="m-auto btn button_main btn-md my__btn__dark">Czytaj więcej <i class="fas fa-angle-right"></i></a>
    				<?php endif; ?>
    			</div>
